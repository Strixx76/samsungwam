...
- Possibility to change API port of speaker when adding a new speaker.
- Fix volume level 0
- Implementing GetFeature API call to support different max volumes.
...
[0.2.2]: https://github.com/Strixx76/samsungwam/tree/v0.2.2
